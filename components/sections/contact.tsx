        ...
        <div className="grid auto-rows-fr gap-4 py-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6 lg:px-10">
          {CONTACT_LINKS.map((link) => (
            ...
            >
              ...
              <span className="w-fit max-w-full break-words text-xl font-semibold underline decoration-black/40 underline-offset-4 transition-colors group-hover:text-black/60 sm:text-2xl">
                {link.value}
              </span>
            </a>
          ))}
